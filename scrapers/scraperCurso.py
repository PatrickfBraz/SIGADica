...
hrl_base = getenv('API_HOST', "http://localhost/")
...
def getPageCursoFromLink(linkCurso):
    ...
    tree = html.fromstring(response.content)
    link = 'https://siga.ufrj.br/sira/repositorio-curriculo/' + tree.cssselect('#frameDynamic')[
        0].get('src')
    print(link)
...
def getCodigoCurso(pageString):
    ...
    elements = tree.cssselect(
        'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitle > td > center > b > tr:nth-child(2) > td:nth-child(4)')
    ...
    elements = tree.cssselect(
        'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr:nth-child(3) > td:nth-child(4)')
...
def getSituacao(pageString):
    tree = html.fromstring(pageString)
    elements = tree.cssselect(
        'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitle > td > center > b > tr:nth-child(4) > td:nth-child(2) > table > tr.tableBodyBlue2 > td:nth-child(2) >nobr')
    situacao = ''
    ...
    elements = tree.cssselect(
        'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody >   tr:nth-child(5) > td:nth-child(2) > table > tr.tableBodyBlue2 > td:nth-child(2) >nobr')
...
def getNomeCurso(pageString):
    tree = html.fromstring(pageString)
    element = tree.cssselect(
        'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitle > td > center > b')[
        0]
...
def getPeriodos(pageString):
    tree = html.fromstring(pageString)
    elements = tree.cssselect(
        'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitle > td > center > b > tr:nth-child(3) > td:nth-child(1) > table > tr.tableBodyBlue1 > td:nth-child(2)')
    duracao = ''
    element = None
    ...
    if (len(elements) > 0):
        ...
        elements = tree.cssselect(
            'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr:nth-child(4) > td:nth-child(1) > table > tr.tableBodyBlue1 > td:nth-child(2)')
        element = elements[0]
        duracao = element.text.split(' ')[0]
...
def getAnoCurriculo(pageString):
    ...
    try:
        element = tree.cssselect(
            'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitle > td > center > b > tr.tableTitleBlue > td > center > b ')[
            0]
    except:
        element = tree.cssselect(
            'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitleBlue > td > center > b ')[
            0]
...
def getPeriodosMaximo(pageString):
    ...
    try:
        element = tree.cssselect(
            'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitle > td > center > b > tr:nth-child(3) > td:nth-child(1) > table > tr.tableBodyBlue2 > td:nth-child(2)')[
            0]
    except:
        element = tree.cssselect(
            'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody >  tr:nth-child(4) > td:nth-child(1) > table > tr.tableBodyBlue2 > td:nth-child(2)')[
            0]
...
def getDuracaoMinima(pageString):
    ...
    try:
        element = tree.cssselect(
            'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr.tableTitle > td > center > b > tr:nth-child(3) > td:nth-child(1) > table > tr.tableBodyBlue1 > td:nth-child(2) > table > tr > td > nobr')[
            0]
    except:
        element = tree.cssselect(
            'body > table > tbody > tr:nth-child(1) > td > table > tr > td > table > tbody > tr:nth-child(4) > td:nth-child(1) > table > tr.tableBodyBlue1 > td:nth-child(2) > table > tr > td > nobr')[
            0]
...
def main():
    ...
    for i in range(6, len(linksCursos)):
        ...
        print("status de resposta: %s" % response.status_code)
        print("Mensagem: %s" % response.json())
        idCurso = response.json()['id_curso']
        for indexTabela in range(1, len(tabelas) - 3):
            print('Manipulando Curso ', i + 1, '/', len(linksCursos))
            if ('Para fazer jus ao grau e diploma, o aluno dever' in str(
                    html.tostring(tabelas[indexTabela]))):
                break
